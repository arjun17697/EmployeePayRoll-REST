...
import EmployeePayroll.exception.EmployeePayrollException;
import EmployeePayroll.service.EmployeePayrollService;
...
public class EmployeePayrollRESTAssuredTest {
	...
	public void givenNewSalaryForEmployee_WhenUpdated_ShouldMatchStatusCode() {
		...
		try {
			employeePayrollService.updateEmployeeSalary("John", 300000.00);
